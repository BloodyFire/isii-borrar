namespace OneHope.UT.PortatilesController_test
{
    public class GetPortatilesParaPedido_test : OneHope4SqliteUT
    {
        public GetPortatilesParaPedido_test()
        {
            ...
            {
                new Portatil(id: 1, modelo: "HP-1151", procesador: procesador, ram: ram, marca: marcas[0], nombre: "HP 486 del pleistoceno", precioCompra: 199.95, precioAlquiler: 6.66, precioCoste: 50.00, stock: 0, stockAlquilar: 5, proveedor: proveedores[0]),
                new Portatil(2, "DELL-1244", procesador, ram, marcas[1], "DELL R5 gama alta", 1999.95, 66.66, 500.00, 1, 1, proveedores[0]),
                new Portatil(3, "ASUS-1362", procesador, ram, marcas[0], "portatilote grandote marca asus perfecto para ir de camping.", 699.95, 23.33, 175.00, 5, 5, proveedores[1]),
                new Portatil(4, "TOASTER-1421", procesador, ram, marcas[1], "Portatil de 82 pulgadas. (Para empotrar en la pared)", 1299.95, 43.33, 325.00, 15, 6, proveedores[1])
            };
