...
namespace OneHope.Web {
    ...
    public class ComprarPortatilStateContainer {
        ...
        public ComprarPortatilStateContainer()
        {
            Compra.DireccionEnvio = "";
            Compra.NombreUsuario = "";
            Compra.ApellidosUsuario = "";
        }
        ...
        public void AddPortatilACompra(PortatilParaComprarDTO portatil, int? cantidad) {
            ...
            if (!Compra.LineaCompra.Any(li => li.PortatilID == portatil.Id)) {
                ...
                Compra.LineaCompra.Add(LineaCompra(portatil.Id, portatil.Nombre, portatil.PrecioCompra, portatil.Marca, portatil.Procesador, portatil.Ram, cant));
            }
        }
        ...
        {
            Compra.DireccionEnvio= direccion;
        }

        public void SetApellidos(string apellidos)
        {
            Compra.ApellidosUsuario = apellidos;
        }

        public void SetNombre(string nombre)
        {
            Compra.NombreUsuario = nombre;
        }
